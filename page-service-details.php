                ...
                <div class="col-xl-4 col-lg-4">
                    <div class="service-sidebar">
                        ...
                        <div class="sidebar-widget service-sidebar-single">
                            <div class="service-sidebar wow fadeInUp" data-wow-delay="0.1s" data-wow-duration="1200m">
                                <div class="service-list">
                                    <ul>
                                        <li><a href="page-service-details.php" class="current"><i class="fas fa-angle-right"></i><span>Digital Marketing</span></a></li>
                                        <li><a href="page-service-details.php"><i class="fas fa-angle-right"></i><span>UI/UX Designing</span></a></li>
                                        <li><a href="page-service-details.php"><i class="fas fa-angle-right"></i><span>Product Development</span></a></li>
                                        <li><a href="page-service-details.php"><i class="fas fa-angle-right"></i><span>Data Analysis</span></a></li>
                                        <li><a href="page-service-details.php"><i class="fas fa-angle-right"></i><span>Security System</span></a></li>
                                        <li><a href="page-service-details.php"><i class="fas fa-angle-right"></i><span>Data Visualization</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="sidebar-widget banner-widget">
                            <div class="widget-content" style="background-image: url(assets/images/resource/contact.jpg);">
                                <div class="shape" style="background-image: url(assets/images/resource/overlay-shape.png);"></div>
                                <div class="content-box">
                                    <div class="icon-box">
                                        <i class="lnr lnr-icon-pie-chart"></i>
                                    </div>
                                    <h3>Be healthy & eat only fresh</h3>
                                    <a href="page-contact.php" class="theme-btn btn-style-one"><span class="btn-title"> Contact us</span></a>
                                </div>
                            </div>
                        </div>
