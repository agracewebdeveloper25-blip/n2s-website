...
<?php include './layout/layout-top.php'?>
	...
	<!-- About Section -->
	<section id="about" class="about-section pb-80 pt-0">
		<!-- Features Section -->
	...
	<!-- Project Section -->
	<section id="project" class="project-section-two">
		<div class="auto-container">
	...
	<!-- Contact Section -->
	<section id="contact" class="contact-section-two pull-up">
		<div class="auto-container">
			<div class="row">
				<!-- Info Column -->
	...
	<!-- News Section -->
	<section id="news" class="news-section alternate">
