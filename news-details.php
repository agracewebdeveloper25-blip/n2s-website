				...
				<div class="col-xl-8 col-lg-7">
					<div class="blog-details__left">
						...
						<div class="blog-details__bottom">
							<p class="blog-details__tags"> <span>Tags</span> <a href="news-details.php">Agriculture</a> <a href="news-details.php">Farm</a> </p>
						...
						<div class="nav-links">
							<div class="prev">
								<a href="news-details.php" rel="prev">True factors of the modern healthy lifestyle</a>
							</div>
							<div class="next">
						...
						<div class="comment-one">
							...
							<div class="comment-one__single">
								<div class="comment-one__image"> <img src="assets/images/resource/testi-thumb-1.jpg" alt=""> </div>
							...
							<div class="comment-one__single">
								<div class="comment-one__image"> <img src="assets/images/resource/testi-thumb-2.jpg" alt=""> </div>
								<div class="comment-one__content">
									<h3>Sarah Albert</h3>
									<p>Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla.
										Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla,
					...
					<div class="sidebar">
								...
								<li>
									...
									<div class="sidebar__post-content">
										<h3> <span class="sidebar__post-content-meta"><i
											class="fas fa-user-circle"></i>Admin</span> <a href="news-details.php">Top crypto exchange influencers</a>
										</h3>
									</div>
								</li>
								<li>
									...
									<div class="sidebar__post-content">
										<h3> <span class="sidebar__post-content-meta"><i
											class="fas fa-user-circle"></i>Admin</span> <a href="news-details.php">Necessity may give us best virtual court</a> </h3>
									</div>
								</li>
								<li>
									...
									<div class="sidebar__post-content">
										<h3> <span class="sidebar__post-content-meta"><i
											class="fas fa-user-circle"></i>Admin</span> <a href="news-details.php">You should know about business plan</a> </h3>
									</div>
								</li>
							</ul>
						</div>
						<div class="sidebar__single sidebar__category">
							...
							<ul class="sidebar__category-list list-unstyled">
								<li><a href="news-details.php">Artifical Intelligence<span
									class="icon-right-arrow"></span></a> </li>
								<li class="active"><a href="news-details.php">Cloud Solution<span
									class="icon-right-arrow"></span></a></li>
								<li><a href="news-details.php">Cyber Data<span
									class="icon-right-arrow"></span></a> </li>
								<li><a href="news-details.php">SEO Marketing<span
									class="icon-right-arrow"></span></a> </li>
								<li><a href="news-details.php">UI/UX Design<span
									class="icon-right-arrow"></span></a> </li>
								<li><a href="news-details.php">Web Development<span
									class="icon-right-arrow"></span></a> </li>
							</ul>
						</div>
						<div class="sidebar__single sidebar__tags">
							<h3 class="sidebar__title">Tags</h3>
							<div class="sidebar__tags-list"> <a href="#">Consulting</a> <a href="#">Cyber</a> <a href="#">Development</a> <a href="#">Digital</a> <a href="#">Software</a> <a href="#">Technology</a> </div>
						</div>
