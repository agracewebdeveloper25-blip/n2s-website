...
<html lang="en">
    ...
    <body>
                ...
                <div class="row g-4 align-items-center">
                    <div class="col-lg-6">
                        <div class="hero-content">
                            <h6 class="wow fadeInUp">Applying Data security</h6>
                            <h1 class="wow fadeInUp" data-wow-delay=".3s">Security Analytics For Big Data.</h1>
        ...
        <section class="service-section-3 section-padding pt-0" id="service">
            ...
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="wow fadeInUp" data-wow-delay=".3s">We Provide the Best Quality</h2>
                </div>
                <div class="row">
        ...
        <!-- About Section Start -->
        <section class="about-section section-padding fix bg-cover pt-0 mb-2" id="about">
            <div class="container">
        ...
        <section class="project-section fix section-padding pt-0 mt-4" id="project">
            <div class="container">
                <div class="section-title text-center">
            ...
            <div class="swiper project-slider">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="project-items style-2">
                            <div class="project-image">
                                <img src="assets/img/project/13.jpg" alt="project-img">
                                <div class="project-content">
                                    <p>Technology</p>
                                    <h4>
                                        <a href="project-details.html">Data Analysis</a>
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="project-items style-2">
                            <div class="project-image">
                                <img src="assets/img/project/14.jpg" alt="project-img">
                                <div class="project-content">
                                    <p>Solution</p>
                                    <h4>
                                        <a href="project-details.html">Backup & Recovery</a>
                                    </h4>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="project-items style-2">
                            <div class="project-image">
                                <img src="assets/img/project/15.jpg" alt="project-img">
                                <div class="project-content">
                                    <p>Technology</p>
                                    <h4>
        ...
        <!--<< Team Section Start >>-->
        <section class="team-section-4 fix section-padding pt-0" id="team">
            <div class="container">
        ...
        <section class="testimonial-section-4 fix section-padding bg-cover" style="background-image: url('assets/img/section-bg.jpg');">
            <div class="container">
        ...
        <!-- News Section Start -->
        <section class="news-section-4 fix section-padding bg-cover" style="background-image: url('assets/img/section-bg.jpg');" id="blog">
            <div class="container">
                <div class="section-title text-center">
