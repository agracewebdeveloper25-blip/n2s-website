...
<html lang="en">
    ...
    <body>
        ...
        <section class="service-section fix section-padding bg-cover" id="service" style="background-image: url('assets/img/service/service-bg.jpg');">
            <div class="container">
        ...
        <section class="project-section section-padding pt-0 fix" id="project">
        ...
        <!--<< Team Section Start >>-->
        <section class="team-section section-padding pt-0 section-bg-2" id="team">
            <div class="line-shape">
