                            ...
                            <div class="main-sidebar">
                                <div class="single-sidebar-widget">
                                    ...
                                    <div class="widget-categories">
                                        <ul>
                                            <li><a href="service-details.html">Database Security</a><i class="fa-solid fa-arrow-right-long"></i></li>
                                            <li><a href="service-details.html">IT Consultancy</a><i class="fa-solid fa-arrow-right-long"></i></li>
                                            <li class="active"><a href="service-details.html">App Development</a><i class="fa-solid fa-arrow-right-long"></i></li>
                                            <li><a href="service-details.html">UI/UX Design</a><i class="fa-solid fa-arrow-right-long"></i></li>
                                            <li><a href="service-details.html">Cyber Security</a><i class="fa-solid fa-arrow-right-long"></i></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="single-sidebar-widget">
                                ...
                                <div class="single-sidebar-image bg-cover" style="background-image: url('assets/img/service/post.jpg');">
