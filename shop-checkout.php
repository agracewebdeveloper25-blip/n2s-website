          ...
          <div class="row mt-30">
            ...
            <div class="col-md-12 mt-30">
              ...
              <table class="table table-striped table-bordered tbl-shopping-cart">
                ...
                <tbody>
                  <tr>
                    <td class="product-thumbnail"><a href="shop-product-details.php"><img alt="product" src="assets/images/resource/products/1.jpg"></a></td>
                    <td class="product-name"><a href="shop-product-details.php">Headphone</a> x 2</td>
                    <td><span class="amount">$36.00</span></td>
                  </tr>
                  <tr>
                    <td class="product-thumbnail"><a href="shop-product-details.php"><img alt="product" src="assets/images/resource/products/2.jpg"></a></td>
                    <td class="product-name"><a href="shop-product-details.php">Lagage</a> x 3</td>
                    <td><span class="amount">$115.00</span></td>
                  </tr>
                  <tr>
                    <td class="product-thumbnail"><a href="shop-product-details.php"><img alt="product" src="assets/images/resource/products/3.jpg"></a></td>
