							...
							(function($) {
								$("#contact_form").validate({
									submitHandler: function(form) {
										...
										var form_btn_old_msg = form_btn.html(); // corrected from .php()
										form_btn.prop(\'disabled\', true).html(form_btn.data("loading-text")); // corrected from .php()
										...
										$(form).ajaxSubmit({
											...
											success: function(data) {
												...
												form_btn.prop(\'disabled\', false).html(form_btn_old_msg); // corrected from .php()
												$(form_result_div).html(data.message).fadeIn(\'slow\'); // corrected from .php()
												setTimeout(function() {
...
<div class="page-wrapper">
		...
		<div class="main-box">
			...
			<div class="outer-box">
				<a href="tel:+91(9999)9999" class="info-btn-two">
					...
					<small>Call Anytime</small><br> +91 (8800) 6890
				</a>
	...
	<!-- About Section -->
	<section id="about" class="about-section-six pt-0 pb-70">
		<!-- Features Section -->
	...
	<section id="service" class="services-section-four">
	...
	<!-- Project Section -->
	<section id="project" class="project-section style-two pb-0">
		<div class="auto-container">
	...
	<section id="testimonial" class="testimonial-section-four pb-0">
		<div class="auto-container">
			<div class="row">
				<!-- Title Column -->
	...
	<!-- Contact Section -->
	<section id="contact" class="contact-four-section">
		<div class="auto-container">
			<div class="row">
				<!-- map Column -->
